    ...
    : QWidget{parent}
{
    ...
    QFont font_bold("Comic Sans MS", 40,QFont::Bold);
    QPalette palette;
    ...
    QIcon icon_volume(":/new/prefix1/volume_black.png");
    ...
    QIcon icon_return(":/new/prefix1/button_return.png");
...
void hintwindow_1::paintEvent(QPaintEvent *)
{
    ...
    QPixmap pic;
    QPixmap e1;
    e1.load(":/new/prefix1/press_E_1.png");
    QPixmap f1;
    f1.load(":/new/prefix1/press_F_1.png");
    QPixmap s1;
    s1.load(":/new/prefix1/press_S_1.png");
    QPixmap d1;
    d1.load(":/new/prefix1/press_D_1.png");
    QPixmap q1;
    q1.load(":/new/prefix1/press_Q_1.png");
    pic.load(":/new/prefix1/background.png");
...
void hintwindow_1::keyPressEvent(QKeyEvent *event){
    ...
    case Qt::Key_E:
        drawKeyPressedImage(":/new/prefix1/press_E_2.png", 200, 170, 90, 100);
        break;
    case Qt::Key_S:
        drawKeyPressedImage(":/new/prefix1/press_S_2.png", 120, 275, 90, 100);
        break;
    case Qt::Key_D:
        drawKeyPressedImage(":/new/prefix1/press_D_2.png", 220, 275, 90, 100);
        break;
    case Qt::Key_F:
        drawKeyPressedImage(":/new/prefix1/press_F_2.png", 320, 275, 90, 100);
        break;
    case Qt::Key_Q:
        drawKeyPressedImage(":/new/prefix1/press_Q_2.png", 520, 225, 90, 100);
        break;
    }
}
